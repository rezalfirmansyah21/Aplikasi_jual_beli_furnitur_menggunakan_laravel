...
class ProductGalleryController extends Controller
{
    ...
    {
        //untuk menampung semua data yg ada di field files
        $files = $request->file('files');

        //pengecekan apakah ada gambar atau tidak
        if ($request->hasFile('files')) {
            //jika ada gambar maka di looping satu persatu & di taro di variable $path
            foreach ($files as $file) {
                $path = $file->store('public/gallery');

                //setelah itu insert ke database
