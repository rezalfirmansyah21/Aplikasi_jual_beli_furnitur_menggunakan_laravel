	...
	<div class="flex flex-wrap my-4 md:my-12">
			...
			<div class="slider">
				<div class="thumbnail">
					<div class="px-2">
						...
						<!-- looping dan seleksi gambar yg pertama -->
				...
				<div class="preview">
					<div class="item rounded-lg h-full overflow-hidden">
						<!-- ambil data dari product->galleries jika check jika exist/tidak ada, jika ada tampilkan gambar yg first/pertama jika gambar tidak ada tampilkan warna gray-->
		...
		<div class="flex-1 px-4 md:p-6">
			...
			<form action="{{ route('cart-add', $product->id) }}" method="POST">
				@csrf
				<button class="transition-all duration-200 bg-pink-400 text-black focus:bg-black focus:text-pink-400 rounded-full px-8 py-3 mt-4 inline-flex"><svg class="fill-current mr-3" width="26" height="24" viewBox="0 0 26 24">
