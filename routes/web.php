...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    // url {id} untuk dimasukkan ke frontendController -> fungsi cartAdd, agar yg bisa mengakses hanya id sudah login
...
Route::middleware(['auth:sanctum', 'verified'])->name('dashboard.')->prefix('dashboard')->group(function () {
    Route::get('/', [DashboardController::class, 'index'])->name('index'); //biar bikin link nya -> dashboard.index
